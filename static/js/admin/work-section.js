...
const backgroundOverlay1 = document.querySelector(
    "#work-section .video.reasons-report-modal .background-overlay"
);
...
const applyCheckboxes2 = document.querySelectorAll(
    "#work-section .text-wrapper .apply-checkbox"
);
const headerCheckbox2 = document.querySelector(
    "#work-section .text-wrapper input[class=select-all]"
);
...
const sortFilterOptions2 = document.querySelectorAll(
    "#work-section .text-wrapper .sort-filter-option"
); //작성일, 조회수, 평점, 신고관리
...
sortFilterOptions2.forEach((option) => {
    option.addEventListener("click", () => {
        ...
        document
            .querySelector(
                "#work-section .text-wrapper .sort-filter-option.selected"
            )
            .classList.remove("selected");
        option.classList.add("selected");
    });
...
const reportManagements2 = document.querySelectorAll(
    "#work-section .text-wrapper .report-management-btn"
);
const reportManagementModal2 = document.querySelector(
    "#work-section .text.report-management-modal"
);
const btnComplete2 = document.querySelector(
    "#work-section .text.report-management-modal .btn-complete"
);
const reportBackgroundOverlay2 = document.querySelector(
    "#work-section .text.report-management-modal .background-overlay"
);
...
const choiceButtons2 = document.querySelectorAll(
    "#work-section .text.report-management-modal .choice-container > input[type=button]"
);
...
const reasonsReportBtns2 = document.querySelectorAll(
    "#work-section .text-wrapper .reasons-report-btn"
);
const reasonsReportModal2 = document.querySelector(
    "#work-section .text.reasons-report-modal"
);
const closeButton2 = document.querySelector(
    "#work-section .text.reasons-report-modal .close-btn"
);
const backgroundOverlay2 = document.querySelector(
    "#work-section .text.reasons-report-modal .background-overlay"
);
