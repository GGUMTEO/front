...
const menuItems = document.querySelectorAll(
    ".menu-items-menu.menu-items-sub-menu"
);
...
menuItems.forEach((menuToggle) => {
    menuToggle.addEventListener("click", function () {
        ...
        const downIcon = menuToggle.querySelector(
            ".icon-arrow.menu-items-down-icon"
        );
...
const subMenus = document.querySelectorAll(
    ".menu-items-section .menu-items-sub-menu-container .menu-items-sub-menu"
);
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const nav = document.getElementById("aside-navbar-container");
    const mainDiv = document.querySelector("div.layout-body");
    const layoutSections = document.querySelector(".layout-sections");
    let dividerAdded = false;

    button.addEventListener("click", () => {
        button.classList.toggle("AppLayout_expand");
        nav.classList.toggle("aside-navbar-expand");
