        ...
        <div class="img-content-box">
            ...
            <div class="center-text img-box">
                <div class="default-img" id="default-img-${timestamp}">
                    <img id="preview-${timestamp}" src="https://www.wishket.com/static/renewal/img/partner/profile/icon_btn_add_portfolio_image.png" class="mb12" />
                    <video id="video-preview-${timestamp}" class="mb12" style="display: none;" controls></video> <!-- 비디오 미리보기 추가 -->
                    <div class="mb4 img-box-title">작품 영상, 이미지 등록</div>
                    <div class="mb32 body-3 text600 img-box-text">작품 결과물 혹은 설명을 돕는 이미지를 선택해 주세요.</div>
